package com.example.semana8sensores;
        ...
        downloadButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new Thread(new Runnable() {
                    public void run() {
                        final Bitmap bitmap = loadImageFromNetwork("https://img.freepik.com/vector-premium/circulo-flecha-abajo-sobre-fondo-blanco_352279-123.jpg");
